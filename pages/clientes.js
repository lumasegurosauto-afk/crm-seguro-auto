...
export default function ListaClientes() {
  ...
  async function handleUploadTardio(e, apoliceId, clienteId) {
    ...
    try {
      ...
      // Se o cliente veio sem apólice cadastrada, cria uma nova linha na hora
      if (!idDaApolice) {
      ...
      // Passa a lista bruta de arquivos diretamente para o motor extrair
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            ...
            <tbody>
              {clientes.map((c) => {
                ...
                // Mapeia e extrai a apólice com segurança
                let apolice = null;
                if (c.apolices) {
